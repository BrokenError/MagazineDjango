function confirm_save()
    {
        return confirm("Bы уверены, что хотите обновить данные своего аккаунта?\nНезаполненные поля будут очищены!!!");
    }

document.addEventListener('DOMContentLoaded', function() {

    let modalButtons = document.querySelectorAll('#modal_open'), closeButtons = document.querySelectorAll('#modal_close'),
